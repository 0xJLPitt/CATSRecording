...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        font.setPointSize(int(32 * CONFIG['ui_scale']))
        ...
        """)
        self.rc_Deadlift_btn.setFixedSize(int(800 * CONFIG['ui_scale']), int(120 * CONFIG['ui_scale']))
        ...
        """)
        self.rc_Benchpress_btn.setFixedSize(int(800 * CONFIG['ui_scale']), int(120 * CONFIG['ui_scale']))
        ...
        """)
        self.rc_Squat_btn.setFixedSize(int(800 * CONFIG['ui_scale']), int(120 * CONFIG['ui_scale']))
        ...
        # Replay tab
        font.setPointSize(int(36 * CONFIG['ui_scale']))
        ...
        self.rp_Deadlift_btn.setStyleSheet(f"font-size:{int(36 * CONFIG['ui_scale'])}px")
        ...
        self.rp_Benchpress_btn.setStyleSheet(f"font-size:{int(36 * CONFIG['ui_scale'])}px")
        ...
        self.rp_Squat_btn.setStyleSheet(f"font-size:{int(36 * CONFIG['ui_scale'])}px")
        ...
        self.File_comboBox.setStyleSheet(f"font-size:{int(20 * CONFIG['ui_scale'])}px; color:yellow;")  # 字型樣式
        ...
        self.search_LineEdit.setStyleSheet(f"font-size:{int(20 * CONFIG['ui_scale'])}px; color:yellow;")  # 字型樣式
        ...
        self.data_produce_btn_rp.setStyleSheet(f"font-size:{int(20 * CONFIG['ui_scale'])}px; color:yellow; border:1px solid yellow; font-family:'Times New Roman';")  # 外觀樣式
